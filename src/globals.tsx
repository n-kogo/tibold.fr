...
const projects: {
  ...
  'home':{
    ...
    tag: 'home',
    viewbox: [100, 100],
    path : "M71,100 c5.166,-3.5 18.083,-26.5 16.5,-49.667 C85.168,5.921 71,0 71,0",
    mobilePath : "M100,71 c-0.5,0.166 -16.5,18.083 -49.667,16.5 C5.921,85.168 0,71 0,71",
    ...
    images:[
      <div className="presentation">
        ...
        <p>16000 Angoulême</p>
        <Line spaceAround={true} forceLine={true}>
          <LinkWrapper external={true} link={'https://www.linkedin.com/in/thibaut-carcenac-49b16280/'}>
            <img src={require("./assets/logos/linkedin.svg")} alt="LinkedIn Icon"/>
          </LinkWrapper>
          <LinkWrapper external={true} link={"https://github.com/n-kogo"}>
            <img src={require("./assets/logos/github.svg")} alt="Github Icon"/>
          </LinkWrapper>
          <LinkWrapper external={true} link={require('./assets/CV_Thibaut_CARCENAC.pdf')}>
            <img src={require("./assets/logos/cv.svg")}  alt="Curriculum Vitae"/>
          </LinkWrapper>
        </Line>
      </div>
    ]
  ...
  'hens-world':{
    ...
    path: 'M71,0 c10,20 20,30 20,50 S70,90 71,100',
    mobilePath: 'M0,71 c20,10 30,20 50,20 S90,70 100,71',
  ...
  'wittyfit': {
    ...
    path: "M71,100 c0,0 17,-13.799 18.084,-34.25 C90.5,48.524 71.5,33.5 65.229,31.322 c5.084,-2.444 12.65,-8.156 12.65,-14.813 c0,-8.883 -5.35,-16.084 -9.4,-18.184",
    mobilePath: 'M100,71 c0,0 -13.799,17 -34.25,18.084 C48.524,90.5 33.5,71.5 31.322,65.229 c-2.444,5.084 -8.156,12.65 -14.813,12.65 c-8.883,0 -16.084,-5.35 -18.184,-9.4',
    isPathReversed: true,
    closingPath: "L100,0 L100,100Z",
    mobileClosingPath: "L0,100 L100,100Z",
